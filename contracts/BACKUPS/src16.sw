...
// Fuel-specific implementation
abi SRC16 : SRC16Base {
    /// Returns the SRC16Fuel domain separator struct
    fn domain_separator() -> SRC16Domain;
}

// Ethereum-specific implementation
abi EIP712 : SRC16Base {
    /// Returns the EIP712 domain separator struct
...
//     pub fn domain_hash(self) -> b256 {
//         match self {
//             SRC16SuperDomain::Fuel(domain) => domain::domain_hash(domain),
//             SRC16SuperDomain::Eth(domain) => domain::domain_hash(domain),
//         }
//     }
// }
...
impl SRC16SuperDomain {
    ...
    pub fn domain_hash(self) -> b256 {
        match self {
            SRC16SuperDomain::Fuel(domain) => domain.domain_hash(),
            SRC16SuperDomain::Eth(domain) => domain.domain_hash(),
        }
    }
}
